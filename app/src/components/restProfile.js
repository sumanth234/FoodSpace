        ...
        return(
            <View style={{flexDirection:'row',margin:10}}>
                ...
                <View style={{flex:1,justifyContent:'center',alignContent:'center'}}>
                    <Text style={{textAlign:'right',fontSize:18}}>{val.price} /-</Text>
                </View>
            </View>
        )
    }
                ...
                <ScrollView style={{flex:1,backgroundColor:'white'}}>
                    ...
                    <View >
                        <View style={{flexDirection:'row',margin:20}}>
                            ...
                            <TouchableOpacity style={{flex:1}} onPress={this.handleGetDirections.bind(this)}>
                                <View style={{justifyContent:'center',alignItems:'center'}}>
                                    <Image style={{height:25,width:25}} source={require('../../../assets/marker.png')} />
                                </View>
                        ...
                        <View style={{margin:20}}>
                            <Text>Menu Currently not available</Text>
                        </View>}
                    </View> 
                </ScrollView>
                )
